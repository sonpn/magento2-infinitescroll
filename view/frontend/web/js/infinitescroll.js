        ...
        init: function(){
            jQuery(function($) {
                ...
                window.ias.getNextUrl = function(container) {
                    ...
                    jQuery('.category-products-grid ol .product-item-info').mouseenter(function(){
                        jQuery(this).find('.overlay_quickview').show();
                        jQuery(this).find('.button_hover').css('opacity', '1');
                    });
                    jQuery('.category-products-grid ol .product-item-info').mouseleave(function(){
                        jQuery(this).find('.overlay_quickview').hide();
                        jQuery(this).find('.button_hover').css('opacity', '0');
                    });
